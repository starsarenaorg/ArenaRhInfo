...
| THROBBIN | Prism, `0xe8fB470E0685437d7739BD2AacBA60b228800335` | [`0x8FAB988EF068D0f100c5812f56559dEFC7695641`](https://robinhoodchain.blockscout.com/address/0x8FAB988EF068D0f100c5812f56559dEFC7695641?tab=contract) | [`0xbf6CdAe05d9Bc062080453E43F484C65Ae4A70Cc`](https://robinhoodchain.blockscout.com/address/0xbf6CdAe05d9Bc062080453E43F484C65Ae4A70Cc?tab=contract) | [`0xdb1651284D3430f5264F5aF53B0BA0f9b01c8069`](https://robinhoodchain.blockscout.com/address/0xdb1651284D3430f5264F5aF53B0BA0f9b01c8069?tab=contract) | Active |
| PACK | Prism, `0x0145AcbcceFbEd6F303C420bEeaaAc72E905430b` | [`0x3124c30b80FD6dD1b8815Ec2714036fD566456ef`](https://robinhoodchain.blockscout.com/address/0x3124c30b80FD6dD1b8815Ec2714036fD566456ef?tab=contract) | [`0x372F890BEcB95FeCBD94384FfE95e7f79D358905`](https://robinhoodchain.blockscout.com/address/0x372F890BEcB95FeCBD94384FfE95e7f79D358905?tab=contract) | [`0x9b77bBf3BEb310D18410a84E8e76e137f11A9061`](https://robinhoodchain.blockscout.com/address/0x9b77bBf3BEb310D18410a84E8e76e137f11A9061?tab=contract) | Active |

THROBBIN is live in the production Prism registry. Its manager is unpaused,
LP deployment is enabled, the production Prism native router is set as
`NATIVE_HELPER`, and the production pool deployer authorizes the manager.
...
| THROBBIN | `780,686` | `11,804,822.137197285464322404` | No native post-bond pool |
| PACK | `2,408,411` | `3,826,531.009449799058383308` | `25,000 / 250` |

THROBBIN and PACK production frontend targets are USD snapshot targets. The
selected `780,686` THROBBIN scaler yields
`11,804,822.137197285464322404` THROBBIN, approximately `$4,500` at the
reviewed `$0.0003812` USD/THROBBIN price. The selected `2,408,411` PACK
scaler yields `3,826,531.009449799058383308` PACK, approximately `$4,500` at
the reviewed `$0.001176` USD/PACK price.
